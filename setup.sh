...
APP_ID="${SOKETI_APP_ID:-${SOKETI_DEFAULT_APP_ID:-fuze-store-app-id}}"
APP_KEY="${SOKETI_APP_KEY:-${SOKETI_DEFAULT_APP_KEY:-fuze-store-app-key}}"
APP_SECRET="${SOKETI_APP_SECRET:-${SOKETI_DEFAULT_APP_SECRET:-fuze-store-app-secret}}"
